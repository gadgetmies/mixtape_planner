...
function App() {
  ...
  return (
    <Container maxWidth="md">
      ...
      <p>
        Start by dropping a list of tracks below, selecing the track to start from, the track to end up at and the mood
        you are after. Let the planner work its magic and prepare to be amazed by the combinations it spits out!
      </p>
      <h2>Parameters</h2>
      <h3>
        Playlist{' '}
